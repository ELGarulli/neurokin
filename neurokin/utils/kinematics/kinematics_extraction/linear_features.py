...
def compute_acceleration(df: NDArray, bodyparts: List[int], filter_window: int = 3, order: int = 2) -> NDArray:
    """
...
def smooth_trajectory(df: NDArray, bodyparts: List[int], filter_window: int = 3, order: int = 1, deriv: int = 0) -> NDArray:
    """
